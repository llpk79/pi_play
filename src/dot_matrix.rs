...
impl DotMatrixData {
    pub fn new() -> DotMatrixData {
        ...
        let line_stay_same = [
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
            0x10, 0x08, 0x10, 0x20, 0x10, 0x54, 0x38, 0x10, // line stay same
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        ].to_vec();
        let pressure = [
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        ...
        let humidity = [
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
            0x7E,0x08,0x08,0x7E,0x00,0x3C,0x20,0x20,
            0x20,0x20,0x3C,0x00,0x7C,0x04,0x78,0x04,
            0x78,0x00,0x40,
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        ...
        let rev_line_stay_same = [
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
            0x10,0x38, 0x54, 0x10, 0x20, 0x10, 0x08, 0x10,0x10,0x10,  // rev line stay same
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        ].to_vec();
        let i_heart_macey = [
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        ...
        let data = Vec::from([line_go_down, line_go_up, line_stay_same, rev_line_stay_same, pressure, temp, humidity, i_heart_macey]);
